    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if(!numberString.matches("[0-9]+")|| Integer.parseInt(numberString)<=0){
                System.out.println(RED+"\tNumber of hall is allow only number and more then 0!"+RESET);
                checkAgain = true;
            }else{
                checkAgain = false;
            }
        ...
        numberString = scanner.nextLine();
        if(!numberString.matches("[0-9]+") || Integer.parseInt(numberString)<=0){
            System.out.println(RED+"\tNumber of seat is allow only number and more then 0!"+RESET);
            checkAgain = true;
        }else {
            checkAgain = false;
        }
